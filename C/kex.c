...
{ // Alice's ephemeral key-pair generation
  ...
  // CurveIsogeny must be set up in advance using SIDH_curve_initialize().
    ...
    if (Status != CRYPTO_SUCCESS) {
     ...
     //printf("CurveIsogeny->PA: ");
     //for (i = 0; i < 11; i++) {
     //   printf("%lu", (digit_t*)CurveIsogeny->PA[i]);
     //}
     //printf("\n");
